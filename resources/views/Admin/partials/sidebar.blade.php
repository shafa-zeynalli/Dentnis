...
{{--            </ul>--}}
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-table"></i><span class="app-menu__label">Tables</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="{{route('admin.teams.index',$lang)}}"><i class="icon bi bi-circle-fill"></i> Teams</a></li>
                <li><a class="treeview-item" href="{{route('admin.slider.index')}}"><i class="icon bi bi-circle-fill"></i> Slider Images</a></li>
            </ul>
        </li>
